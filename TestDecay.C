...
//        eepair.Print();
 ...
 ////////////////////////////////////////////////////////////////////////////
  ...
  TH1D *h_R_gpi       = (TH1D*)h_ptpi->Clone("h_R_gpi");
  TH1D *h_R_ghad      = (TH1D*)h_pt_g->Clone("h_R_ghad");
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  TH1D *ptr2 = plot.Frame("ptr2","p_{T} [GeV/c^{2}]","#pi^{0}/#gamma_{hadron}",pt_low,pt_high*.999,0.002,4.2);
  ptr2->Draw();
  h_R_gpi->Draw("same Chist");
