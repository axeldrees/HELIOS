...
// - ReconstructParticleShower(ID, particle, vtx2) 
//
...
// - PhiV(particle1,particle2)                phi V orientation of pair to magnetic field, used to reject pothon conversions
//
// EMCal
...
//
// Axel Drees
// updated 11/22/2022                                           Axel Drees
// 22/03/2023  added off vertex(0,0,0) origin for EMCAL         Axel Drees  (note: this does not yet work for the tracking!)
// 23/05/2025  add phi V cut                                    Axel Drees
//
///////////////////////////////////////////////////////////////////////////////////
...
// pair quantities
  Double_t PhiV(TLorentzVector particle1, TLorentzVector Particle2) ; // calculates phiV of pair
