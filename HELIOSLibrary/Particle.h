...
// GenerateVTX()   - generates decay vertex
//
...
//  TVector3 GetDecayVTX()          - returns location of decay vertex, default is 0,0,0
// 
...
// 3/21/2023    add more particles & decays Axel Drees
// 3/22/2023    add finite decay length     Axel Drees
// 4/16/2025    add virtual photon          Axel Drees
//
#ifndef Particle_h
#define Particle_h
...
// public random generator functions for particle 4 vector 
  ...
  void GenerateP(Double_t ptmin, Double_t ptmax, Double_t ymin, Double_t ymax, Bool_t rap=true); 
                                                               // generate flat pt between min and max, -pi<phi<pi, ymin<y<ymax
                                                               // rap=false uses pseudorapidity, if true use rapidity
